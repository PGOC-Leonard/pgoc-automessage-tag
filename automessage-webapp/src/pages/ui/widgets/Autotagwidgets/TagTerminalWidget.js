...
function TagTerminalWidget({ messages, resetTerminal }) {
  ...
  return (
    <div className="relative w-[780px] bg-gray-300  rounded-lg  shadow-xl">
      ...
      <div
        id="terminal"
        className="relative w-full h-[310px] bg-gray-200 text-black font-mono p-4 rounded-lg border-2 border-gray-300 shadow-xl overflow-y-auto"
      >
        {/* Messages container */}
...
export default TagTerminalWidget;
