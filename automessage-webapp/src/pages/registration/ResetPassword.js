    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md relative">
        <div className="text-center mb-4">
          ...
          <h1 className="text-2xl font-bold text-red-600 mt-4">Reset Password</h1>
          {isTokenValid === false && <p className="text-red-500 mt-2">{error}</p>}
        </div>
        {isTokenValid && (
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:bg-gray-400"
            >
